...
void main() {
  testWidgets(
      'Rsv Confirmation Page shows the summary of reservation and payment based on venues and selected date from the constructor.',
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: MultiProvider(
          ...
          child: RsvConfirmationPage(mockVenue, DateTime(2025, 02, 24)),
        ),
      ),
    );
